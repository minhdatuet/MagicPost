...
function Warehouse() {
  ...
  return (
    <div className="dashboard-content">
      <HeaderRole btnText="Thêm kho hàng" onClick={setIsModalOpen} />
            ...
            <tbody>
              {warehousesAll.map((warehouse, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <span>{warehouse.warehouseLeader?.name}</span>
                  </td>
                  <td>
                    <ul className="list-inline m-0">
                      <li className="list-inline-item">
                        <button
                          ...
                          data-placement="top"
                          title="Eye"
                          onClick={(e) => onHandlerShowInfoWarehouse(warehouse)}
                        >
                          <i class="fa fa-eye"></i>
                        </button>
                      </li>
                      <li className="list-inline-item">
                        <button
                          ...
                          data-placement="top"
                          title="Edit"
                          onClick={(e) => handleOpenUpdateModal(warehouse)}
                        >
