    ...
    <>
      ...
      <div className="container mt-4">
        ...
        <Form noValidate validated={validated} onSubmit={handleSubmit}>
          ...
          <Row>
            <Form.Group as={Col} md="6" controlId="goodsType">
              ...
              <div style={{
                ...
                <Form.Check
                  type="checkbox"
                  label="hàng hoá (goods)"
                  id="goods"
                  checked={selectedTypes.goods}
                  onChange={handleCheckboxChange}
                />
                <Form.Check
                  type="checkbox"
                  ...
                  <div className="infoPackage">
                    ...
                    <div className="flex4">
                      ...
                      <div className="flex5">
                        ...
                        <p>{selectedTypesList.length > 0 ? selectedTypesList.join(', ') : 'Không có loại hàng hóa nào được chọn'}</p>
                      </div>
                      {/* <div className="flex5">
